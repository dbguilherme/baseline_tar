...
class EvalMeasure(object):
    ...
    def update(self, judgment, value, action):
        ...
        """
        #if judgment==1:
            #print ("update ", judgment, " ", value," ", action)
...
class CountBasedMeasures(DescriptionMeasures):
    ...
    def __init__(self, topic_id, num_docs, num_rels):
        ...
        self.cost= 0.0 # Percentage of documents to be read; Task 1 and Task 2

        self.outputs ={'num_shown':0, 'rels_found':0, 'num_rels':0,
                       'last_rel':1, 'norm_last_rel':1, 'threshold': 1,
                       'norm_threshold': 1, 'wss_100':1, 'wss_95':1,'cost':0}
    ...
    def update_all(self, judgment, value):
        ...
        if judgment > 0 and judgment < 3:
            ...
            #print(" self.rels_found ", self.rels_found, " self.last_rel  " , self.last_rel )
    def update_post(self,judgment, value, action):
        if int(action) == 1:
    ...
    def finalize(self):
        ...
        #print("wss ", self.num_docs, "  self.last_rel ",  self.last_rel ,"  self.last_rel ", self.num_shown)
        ...
        #print("wss ", self.num_docs, "self.last_rel_95 " , self.last_rel_95, "  self.last_rel ", self.num_docs)
        ...
        self.cost=(float(self.num_shown - self.num_docs)
...
class MAPBasedMeasures(DescriptionMeasures):
    ...
    def update_all(self, judgment, value):
        ...
        if judgment > 0 and judgment < 3:
            ...
            self.cost=(float(self.num_shown/float(self.num_docs)))
...
class GainBasedMeasures(DescriptionMeasures):
    ...
    def update_all(self, judgment, value):
        ...
        if value > 0 and value < 3:
            ...
            v = 1.0
        #print (" self.cg_total ",self.cg_total ,  " self.last_rank ", self.last_rank)
    ...
    def update_post(self, judgment, value, action):
        ...
        ##print(self.topic_id  , "   self.rng  ", self.rng)
        if self.last_rank in self.rng: # if you have reached % of the documents shown then
            ...
            ##print("entrou aqui ", self.cgat + " self.cgat[p] " +self.topic_id  ,' xxxxxxx  ', self.cg_total)
    ...
    def print_scores(self):
        ...
        #print(self.topic_id ,"  x...",self.cgat)
        percent = 0
        for i in range(0,self.maxt):
            ...
            if self.cg_max > 0.0:
                ...
                #print("---------------------- ",  x ,  " ", self.cgat[i], " --- ",self.cg_max, "---- ", self.maxt )
...
class RecallBasedMeasures(DescriptionMeasures):
    ...
    def __init__(self, topic_id, num_docs, num_rels):
        ...
        self.recall_levels = [10,50,100,200,300,400,500,1000,2000,3000,4000,5000]
